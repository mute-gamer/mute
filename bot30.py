...
async def send_promotion():
    messages = [
        "🚀 Don't miss out! Subscribe now for the latest content! 🔥",
        "🔥 Join the adventure! Hit that subscribe button! 💥",
        "🎯 Like what you see? Subscribe for more updates! 🚀",
        "✨ Stay ahead! Subscribe and enjoy exclusive content! 💡",
        "📢 Want more exciting videos? Subscribe now! 🎉",
    ]
...
def schedule_promotion():
    schedule.every(30).seconds.do(lambda: asyncio.create_task(send_promotion()))
